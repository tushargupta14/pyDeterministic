...
empirical parameters. The growth rate is now given by the power-law expression given by \cite{nagy} and \cite{nagy2}:
\begin{equation}
G = k_{g}(S-1)^{g}
\end{equation}
...
The values for the set of kinetic parameters $[k_{g}, g, k_{j_{1}, k_{j_{2}}} ]$ have been mentioned in the \ref{Table4} (\cite{bhoi}).
